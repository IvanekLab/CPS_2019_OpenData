...
;  file-close
  ...
  let headings-file-2 [ "who" "zone-item" "zone-category" "height" "area" "cleanable" "equipment" "location" "room" "out-links" "in-links" "undirected-links" ] ;making col header of file "ZoneData.csv"
...
to write-output [file-number]
  ...
  foreach sort-on [ who ] zones
   ...
   [;let zone-data []
    file-open "ZoneData.csv"
    file-type (word who "," z-item-name "," z-category "," z-height "," z-area "," z-cleanable? "," z-equipment "," z-location "," z-room ","
...
<experiments>
  ...
  <experiment name="sensitivity_prevalence" repetitions="10" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <metric>p11</metric>
    <metric>p12</metric>
